...
return [
    ...
    'Cache' => [
        ...
        /**
         * Cache para la consulta basica de sfbuildings sin condiciones extras, solo lo siguiente.
        ...
        /**
         * Cache para la consulta basica de sfworkers sin condiciones extras, solo lo siguiente.
         * 'conditions' => ['codArn IS NOT NULL', 'codArn NOT IN' => ['001', '002', '004']]]);
         */
        ...
        /**
         * Cache para la mascara
         */
        'config_cache_mascara' => [
            'className' => 'File',
            'prefix' => 'mascara_',
            'path' => CACHE,
            'serialize' => true,
    ...
    'Datasources' => [
        'default' => [
         ...
         /**
         * The softland connection is used during the softland suite.
         */
        'softland' => [
            'className' => 'Cake\Database\Connection',
            'driver' => 'Cake\Database\Driver\Sqlserver',
            'persistent' => false,
            'host' => '186.67.204.85\SOSQL2012',
            //'port' => 'nonstandard_port_number',
            'username' => 'IdeaUno',
            'password' => 'chile.123',
            'database' => 'LARRAIN',
        ...
        'iconstruye' => [
            ...
            'driver' => 'Cake\Database\Driver\Sqlserver',
            'persistent' => false,
            'host' => 'DESKTOP-BSO3MHT\SQLEXPRESS',
            //'port' => 'nonstandard_port_number',
            'username' => 'sa',
            'password' => '1234',
            'database' => 'BackUpLDZ',
