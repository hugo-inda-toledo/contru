jQuery(document).ready(function($) {
    ...
    $(document).on('change', 'input[data-all_day="1"]', function(event) {
        event.preventDefault();
        console.log('all day cheched: '+$(this).is(':checked'));
        if ($(this).is(':checked')) {
            ...
            $(this).parent().parent().parent().next('td').next('td').children().hide();
            ...
            $(this).parent().parent().parent().next('td').next('td').children().show();
    ...
    $(document).on('change', 'input[data-assistance="1"]', function(event) {
        event.preventDefault();
        console.log('asistio cheched: '+$(this).is(':checked'));
