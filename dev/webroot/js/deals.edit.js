                ...
                $('#workerstable tbody').append(
                    '<tr id="trWorker-' + this.value + '" worker="' + this. value + '" workername="' + worker.nombres + '">' +
                            ...
                            '<td>' +
                                ...
                                '<input class="form-control ldz_numeric text-right" type="text" name="workers[' + j + '][amount]" required="required" id="amount-' + this.value + '" max="' + max_deal + '">' +
                            '</td>' +
                            '<td id="tdWorker-' + worker.id + '-items"><a href="#" id="formItems" class="formItems btn btn-sm btn-material-orange-900" data-worker-id="' + worker.id + '">Agregar<div class="ripple-wrapper"></div></a></td>' +
                    '</tr>');
