...
use App\Model\Entity\GuideEntry;
use Cake\ORM\Query;
 ...
 * GuideEntries Model
 */
class GuideEntriesTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('warehouse', 'create')
            ->notEmpty('warehouse');
            
        $validator
            ->add('entry_date', 'valid', ['rule' => 'datetime'])
