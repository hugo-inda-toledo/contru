...
use App\Model\Entity\PaymentStatementState;
use Cake\ORM\Query;
...
/**
 * PaymentStatementStates Model
 *
 * @property \Cake\ORM\Association\HasMany $PaymentStatements */
class PaymentStatementStatesTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->table('payment_statement_states');
