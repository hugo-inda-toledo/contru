...
$this->assign('title_text', __('Editar Planificación'));
...
<!-- panel heading -->
    <div class="panel-heading">
        <h3 class="panel-title">Editar Planificación Semanal</h3>
    </div>
    <div class="panel-body">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
            <?php
                $fecha_start = (isset($this->request->data['start_date'])) ? $this->Time->format($this->request->data['start_date'], 'dd-MM-Y') : $this->Time->format($schedule->start_date, 'dd-MM-Y');
                echo $this->Form->input('start_date', ['type' => 'text', 'data-type' => 'datetimepicker', 'label' => 'Fecha de Inicio', 'value' => $fecha_start]);
                echo $this->Form->input('holidays_week_quantity',['label' => 'Cantidad días feriados semana']);
             ?>
            </div>
        </div>
        <div class="row">
                    ...
                    <tbody>
                        ...
                        foreach ($budget_items as $bi):
                            if(in_array($bi['extra'], array(0,1))):
                                echo $this->element('acordion_schedule_edit',['bi' => $bi, 'schedule_id' => $schedule->id]);
                            endif;
                        endforeach; ?>
                        <tr class="totales">
                            <td></td>
                            ...
                            <td class="text-center">
                                <span class="suma_real ldz_numeric_no_sign"></span>
                            </td>
                            <td class="text-right ldz_numeric_no_sign"></td>
                        </tr>
                    </tbody>
                </table>
