...
<!-- panel heading -->
    <div class="panel-heading">
        <h3 class="panel-title">Agregar Adicionales Presupuesto</h3>
    </div>
    <div class="panel-body">
        ...
        <div class="col-sm-12 col-md-12">
            <?php echo 'El Item recomendado para añadir como primer item extra al presupuesto es: ' . $new_parent; ?>
        </div>
        ...
        <div class="col-sm-12 col-md-12">
          <p> Es posible agregar items adicionales a partidas y/o sub-partidas  ya existentes dentro de el capitulo de controles de cambio.</p>
          <p> Por ejemplo, el capitulo 9 corresponde a controles de cambio y dentro de el ya existen los registros 9.1 y 9.2, para ingresar un registro dentro del item 9.1, solo basta con ingresar una item con 9.1.1 y el sistema automaticamente lo registra como un item dentro de la partida 9.1.</p>
        </div>
        <div class="col-sm-12 col-md-12">
            <div id="example1"></div>
        </div>
