...
<div class="panel panel-material-blue-grey-700">
    ...
    <div class="panel-body">
        ...
        <div class="row">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <?php //echo $this->Form->input('building.client', ['label' => 'Mandante', 'value' => $building->client]);?>
                            <!--</div>
                            <div class="col-md-6 col-sm-6">
                                <?php //echo $this->Form->input('building.address', ['label' => 'Dirección','value' => $building->address]);?>
                            </div>
                            <div class="col-md-6 col-sm-6">-->
                                <?= $this->Form->input('budget.created', ['type' => 'text', 'data-type' => 'datetimepicker', 'label' => 'Fecha Inicio de Obra']);?>
                            </div>
                        </div>
                    </div>
            </div>
                        ...
                        <div class="panel-body">
                            ...
                            <?php
                                echo $this->Form->input('currencies_values.0.value', [
                                    ...
                                    'type' => 'hidden', 'step' => 'any', 'label' => 'Valor en CLP', 'value' => $valorMoneda]);
                                ?>        
                            <!--</div>-->
                        </div>
                    </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12"><?php
                            echo $this->Form->label('file', 'Archivo Excel');
                            echo '<a href="'.$this->request->webroot.'static_files/pptoejemplo.xlsx" class="download_excel">(Descargar Plantilla)</a>';
                            echo $this->Form->input('file', ['type' => 'file', 'label' => false, 'required' => 'required']);
                        ?></div>
            ...
            <div>
                <?= $this->Form->button(__('Continuar'), ['id' => 'save_button']) ?>
                <?php
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <?php 
            if(isset($budget->id))
            {
                echo $this->Form->postLink('Sí, cancelar y volver al listado', ['controller' => 'budget_items', 'action' => 'reset_obra', $budget->id], ['class' => 'btn btn-primary']) ;
            }
            else
            {
                echo $this->Form->postLink('Sí, cancelar y volver al listado', ['controller' => 'buildings', 'action' => 'index'], ['class' => 'btn btn-primary']) ;
            }
        ?>
      </div>
    </div><!-- /.modal-content -->
...
$(document).ready(function(){
    ...
    $(document).on('change', '#currencies-values-0-currency-id', function(event) {
        value = $(this).val();

        $("#currencies-values-0-value").val('');

        $.ajax({url: <?php echo "'".$this->Url->build('/currencies/getLastValueById/')."'";?> + value, success: function(result){
            $("#currencies-values-0-value").val(result);
        }});
