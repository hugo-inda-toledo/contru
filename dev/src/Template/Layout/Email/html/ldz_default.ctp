...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <body>     
		<!-- Start of header -->
		<table width="100%" bgcolor="#455a64" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="header">
		   <tbody>
		      <tr>
		         <td>
		                                          ...
		                                          <tr>
		                                             <td width="169" height="45" align="center">
		                                                <div class="imgpop">
		                                                   ...
		                                                   <img src="cid:logo-id" alt="" border="0" width="160" height="135" style="display:block; border:none; outline:none; text-decoration:none;">
		                                                   </a>
		                                                </div>
		                                             </td>
		                                          </tr>
		                           ...
		                           <tbody>
		                              <tr>
		                                 <td align="center" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 14px;color: #666666" st-content="postfooter">
		                                    Copyright © 2016, LDZCONSTRUCTORA  S.A.
		                                 </td>
		                              </tr>
		                              <!-- Spacing -->
		                              <tr>
