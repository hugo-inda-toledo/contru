...
class DealsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'deals_ibfk_2' => ['type' => 'foreign', 'columns' => ['user_created_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'deals_ibfk_3' => ['type' => 'foreign', 'columns' => ['worker_id'], 'references' => ['workers', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'amount' => 1,
            'start_date' => '2015-10-09 16:20:43',
            'end_date' => '2015-10-09 16:20:43',
            'comment' => 'Lorem ipsum dolor sit amet, aliquet feugiat. Convallis morbi fringilla gravida, phasellus feugiat dapibus velit nunc, pulvinar eget sollicitudin venenatis cum nullam, vivamus ut a sed, mollitia lectus. Nulla vestibulum massa neque ut et, id hendrerit sit, feugiat in taciti enim proin nibh, tempor dignissim, rhoncus duis vestibulum nunc mattis convallis.',
            'created' => '2015-10-09 16:20:43',
            'modified' => '2015-10-09 16:20:43',
            'user_created_id' => 1,
            'user_modified_id' => 1
        ],
    ];
